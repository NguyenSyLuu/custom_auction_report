...
/**
 * Auction block edit form container.
 * @category Magestore
 * @package  Magestore_Auction
 * @module   Auction
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'auction_id';
        $this->_blockGroup = 'Magestore_Auction';
        $this->_controller = 'adminhtml_auction';

        parent::_construct();

        $this->buttonList->update('save', 'label', __('Save Auction'));
        $this->buttonList->update('delete', 'label', __('Delete'));

        if ($this->getRequest()->getParam('current_auction_id')) {
            ...
            if ($auctionId = $this->getRequest()->getParam('auction_id')) {
                $this->_formScripts[] = '
					window.auction_id = '.$auctionId.';
				';
            }
        } else {
            $this->buttonList->add(
